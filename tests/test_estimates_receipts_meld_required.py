    ...
    def test_meld_scoped_paginates_next_until_limit(self, monkeypatch):
        ...
        pages = {
            "estimates/meld/90000014/?limit=3": {
                ...
                "next": "https://app.propertymeld.test/1000/m/1000/api/estimates/meld/90000014/?cursor=abc&limit=100",
            },
    ...
    def test_meld_scoped_stops_fetching_once_limit_collected(self, monkeypatch):
        ...
        pages = {
            "estimates/meld/90000014/?limit=100": {
                ...
                "next": "https://app.propertymeld.test/1000/m/1000/api/estimates/meld/90000014/?cursor=page2&limit=100",
            },
            "estimates/meld/90000014/?cursor=page2&limit=100": {
                "results": [{"id": i} for i in range(9100, 9200)],
                "next": "https://app.propertymeld.test/1000/m/1000/api/estimates/meld/90000014/?cursor=page3&limit=100",
            },
