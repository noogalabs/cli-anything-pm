...
Captures API endpoints for Projects, Invoices, Receipts, Vendor Person004s
...
async def main():
    ...
    print(f"📋 Will capture API endpoints for: Projects, Invoices, Receipts, Vendor Person004s")
    ...
    async with async_playwright() as p:
        ...
        print("="*60)
        vendor_invites_api = await audit_feature(page, "Vendor Person004s", [
